...
certificateName = ""
#firToken
firToken = "7e7eefce33b3c14b4fd1172531708621"
#邮件参数
emailFromUser = ""
emailToUser = ""
emailPassword = ""
...
def buildApp():
    ...
    if isWorkSpace:
        # os.system("cd %s;xcodebuild -workspace %s.xcworkspace -scheme %s -configuration Release -derivedDataPath build/"%(mainPath,targetName,targetName,certificateName))
...
#创建ipa
def cerateIPA():
    os.system ("cd %s;rm -r -f %s.ipa %s.xcarchive"%(mainPath,targetName,targetName))
